...
const IsAuthNavigator = ({setAuth}) => {
      ...
      messages: [
        {
          ...
          content:
            'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad aperiam cupiditate harum illo in incidunt iste necessitatibus nobis recusandae reprehenderit!',
        },
        {
          id: 2,
          sender: 'other',
          img: 'https://i0.wp.com/www.appletips.nl/wp-content/uploads/2018/09/memoji.png?fit=679%2C679&ssl=1',
          content:
            'Lorem ipsum dolor sit amet, iste necessitatibus nobis recusandae reprehenderit!',
        },
        {
          id: 3,
          sender: 'me',
  ...
  return (
    ...
    >
      ...
      >
        {(props) => (
          <BacklogTask {...props} setTitle={setTitle} setUsers={setUsers} />
        )}
      </Stack.Screen>
      <Stack.Screen
        name="Maps2"
